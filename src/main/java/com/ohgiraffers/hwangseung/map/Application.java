package com.ohgiraffers.hwangseung.map;

import com.ohgiraffers.hwangseung.map.member.Member;
import com.ohgiraffers.hwangseung.map.member.MemberTest;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /*
        * com.ohgiraffers.이름.map.member.Member
        * 필드(변수)
        * - userId: String	// 유저 ID
        ...
        *       2. 메소드 com.ohgiraffers.이름.map.member.MemberTest.test1()
