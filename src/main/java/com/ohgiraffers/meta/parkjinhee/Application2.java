package com.ohgiraffers.meta.parkjinhee;

public class Application2 {
    public static void main(String[] args) {
        /* 계산기 프로그래밍 */
        checkMethod();
        String sumResult = sumTwoNumber(10, 20);
        System.out.println(sumResult);
        int multiResult = multiTwoNumber(10, 20);
        System.out.println("10과 20의 곱은 " + multiResult + "입니다.");
    }
